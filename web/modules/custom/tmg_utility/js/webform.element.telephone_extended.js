...
(function ($, Drupal, drupalSettings) {
   ...
   */
  Drupal.behaviors.webformTelephoneInternationalExtended = {
    attach: function (context) {
      if (!$.fn.intlTelInput) {
        return;
      }

      $(context).find('input.js-webform-telephone-international-extended').once('webform-telephone-international').each(function () {
        var $telephone = $(this);
