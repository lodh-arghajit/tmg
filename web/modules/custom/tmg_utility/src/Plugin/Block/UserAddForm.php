 ...
 * @Block(
 *  id = "user_add_block",
 *  admin_label = @Translation("User add block"),
 * )
 */
class UserAddForm extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    $form = \Drupal::entityTypeManager()
      ->getFormObject('user', 'user_profile_add_edit_form')
      ->setEntity($user);
