...
/**
 * Provides a 'tel extended' element.
 *
 * @WebformElement(
 *   id = "tel_extended",
 *   api = "https://api.drupal.org/api/drupal/core!lib!Drupal!Core!Render!Element!Tel.php/class/Tel",
 *   label = @Translation("Telephone extended"), description = @Translation("Provides a form element for entering a telephone number."),
 *   category = @Translation("Advanced elements"),
 * )
 */
class TelephoneExtended extends TextBase {
  ...
  public function prepare(array &$element, WebformSubmissionInterface $webform_submission = NULL) {
    ...
    if (!empty($element['#international']) && $this->librariesManager->isIncluded('jquery.intl-tel-input')) {
      $element['#attached']['library'][] = 'tmg_utility/webform.element.telephone_extended';

      $element['#attributes']['class'][] = 'js-webform-telephone-international-extended';
      ...
      if (!empty($element['#international_only_countries'])) {
        $element['#attributes']['data-webform-telephone-international-only-countries'] = Json::encode($element['#international_only_countries']);
      }
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['telephone']['international_only_countries'] = [
    ...
    $this->elementManager->processElement($form['telephone']['international_only_countries']);
